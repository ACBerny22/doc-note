...
const Component: FC<ComponentProps> = ({}) => {
  ...
  <div className='grid grid-cols-1 lg:grid-cols-2'> 
    ...
    <h1 className='text-xl font-bold'>Busqueda de Medicamentos</h1>
    ...
    <label className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
      <div className="flex gap-2">
          ...
          <button type="submit" className="text-white  right-2.5 bottom-2.5 bg-accent-blue hover:bg-primary-blue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Buscar</button>
      </div>
    </form>
      {meds.map((item) => (
    ...
    <div className='flex flex-col gap-10 m-10 font-poppins'>
      <div className='flex gap-10'>
        <h1 className='text-xl font-bold'>Indicaciones: {childValue} </h1> 
      ...
      <form className='flex flex-col gap-5' onSubmit={handleSubmitTotal}>
        ...
        <button type="submit" 
        className="text-white bg-accent-blue hover:bg-primary-blue focus:ring-4 focus:outline-none
