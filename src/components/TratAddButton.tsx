...
const TratAddButton: FC<TratAddButtonProps> = ({id, isActive}) => {
    ...
    return (
        <div>
            <Link href={{
                    ...
                    className={' disabled flex shadow-lg rounded-xl bg-white justify-center items-center hover:-translate-y-3 transition-all ease-out hover:bg-slate-400 group'}>
